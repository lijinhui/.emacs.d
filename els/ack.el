...
;;    (save-some-buffers (not compilation-ask-about-save) nil)
    ...
    (print (concat ack-command " " args " " pattern " " dir))
    ...
    (sleep-for 2)
    (save-excursion
      (switch-to-buffer ack-full-buffer-name)
      (toggle-read-only)
...
(defun ack-translate-ansi-color(ack-buffer)
  (interactive)
...
;(ansi-format-decode (if (and transient-mark-mode mark-active) (region-beginning)(point-min)) (if (and transient-mark-mode mark-active) (region-end)(max-point)))